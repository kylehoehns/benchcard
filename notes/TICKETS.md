...
| [`one-spelling-per-page`](../work/one-spelling-per-page/) | plan committed — ready to implement; second survey found a guard already green against a URL nothing links to | every internal href lands on the page it names — offline, under the documented dev server, and without a redirect |
