...
Open work lives in GitHub issues; the harness is `AGENTS.md`. This file is the
...
## Closed questions, kept so nobody re-derives them
...
The measurement is written up above, in "Where we actually stand".
