...
test('the refusal lists the 27 selectable rows, one per line', () => {
  assert.equal(validNames.length, 27,
    `expected the 27 --only-able rows, got ${validNames.length}: ${JSON.stringify(validNames)}`);
