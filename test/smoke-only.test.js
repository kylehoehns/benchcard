...
test('the refusal lists the 21 selectable rows, one per line', () => {
  assert.equal(validNames.length, 21,
    `expected the 21 --only-able rows, got ${validNames.length}: ${JSON.stringify(validNames)}`);
