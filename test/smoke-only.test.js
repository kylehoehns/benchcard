...
test('the refusal lists the 23 selectable rows, one per line', () => {
  assert.equal(validNames.length, 23,
    `expected the 23 --only-able rows, got ${validNames.length}: ${JSON.stringify(validNames)}`);
