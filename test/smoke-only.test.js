...
test('the refusal lists the 22 selectable rows, one per line', () => {
  assert.equal(validNames.length, 22,
    `expected the 22 --only-able rows, got ${validNames.length}: ${JSON.stringify(validNames)}`);
