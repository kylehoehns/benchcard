...
test('the refusal lists the 25 selectable rows, one per line', () => {
  assert.equal(validNames.length, 25,
    `expected the 25 --only-able rows, got ${validNames.length}: ${JSON.stringify(validNames)}`);
