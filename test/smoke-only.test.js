...
test('the refusal lists the 31 selectable rows, one per line', () => {
  assert.equal(validNames.length, 31,
    `expected the 31 --only-able rows, got ${validNames.length}: ${JSON.stringify(validNames)}`);
