...
test('the refusal lists the 32 selectable rows, one per line', () => {
  assert.equal(validNames.length, 32,
    `expected the 32 --only-able rows, got ${validNames.length}: ${JSON.stringify(validNames)}`);
